...
def build_match_state(
    ...
    return MatchState(
        ...
        h2h_avg_goals_home=h2h_avg_goals_home,
        h2h_avg_goals_away=h2h_avg_goals_away,
        h2h_ht_matches_count=h2h_ht_matches_count,
        odds_sharp_signal=odds_sharp_signal,
        h2h_core_weight=h2h_core_weight,
        movement_quality=movement_quality,
        ocr_confidence_scale=ocr_confidence_scale,
        line_movement_ah_raw=line_movement_ah_raw,
        line_movement_total_raw=line_movement_total_raw,
        extraction_coverage=extraction_coverage,
        extraction_trust_factor=extraction_trust_factor,
        team_stats_home_shots=team_stats_home_shots,
        team_stats_away_shots=team_stats_away_shots,
        team_stats_home_corners=team_stats_home_corners,
        team_stats_away_corners=team_stats_away_corners,
        team_stats_home_possession=team_stats_home_possession,
        team_stats_away_possession=team_stats_away_possession,
        ...
        team_stats_home_yellows=team_stats_home_yellows,
        team_stats_away_yellows=team_stats_away_yellows,
        team_stats_home_fouls=team_stats_home_fouls,
        team_stats_away_fouls=team_stats_away_fouls,
        prev_over_pct_h=prev_over_pct_h,
        prev_over_pct_a=prev_over_pct_a,
        h2h_ah_home_cover_pct=h2h_ah_home_cover_pct,
        prev_win_pct_h=prev_win_pct_h,
        prev_win_pct_a=prev_win_pct_a,
        recent_xg_prior_h=recent_xg_prior_h,
        recent_xg_prior_a=recent_xg_prior_a,
        motivation_home=motivation_home,
        motivation_away=motivation_away,
        url_form_trend_h=url_form_trend_h,
        url_form_trend_a=url_form_trend_a,
        line_quality_factor=line_quality_factor,
        htft_home_htw_ftw=htft_home_htw_ftw,
        htft_home_htw_ftd=htft_home_htw_ftd,
        htft_home_htw_ftl=htft_home_htw_ftl,
        htft_home_htd_ftw=htft_home_htd_ftw,
        htft_home_htd_ftd=htft_home_htd_ftd,
        htft_home_htd_ftl=htft_home_htd_ftl,
        htft_home_htl_ftw=htft_home_htl_ftw,
        htft_home_htl_ftd=htft_home_htl_ftd,
        htft_home_htl_ftl=htft_home_htl_ftl,
        htft_away_htw_ftw=htft_away_htw_ftw,
        htft_away_htw_ftd=htft_away_htw_ftd,
        htft_away_htw_ftl=htft_away_htw_ftl,
        htft_away_htd_ftw=htft_away_htd_ftw,
        htft_away_htd_ftd=htft_away_htd_ftd,
        htft_away_htd_ftl=htft_away_htd_ftl,
        htft_away_htl_ftw=htft_away_htl_ftw,
        htft_away_htl_ftd=htft_away_htl_ftd,
        htft_away_htl_ftl=htft_away_htl_ftl,
        bankroll=bankroll,
        comm_rate=comm_rate,
    )
