...
if _btn_prematch or _btn_live:
    ...
    _tracking_meta = {
        ...
        "p_over_bp_eu": float(getattr(risultati, "p_over_bp_eu", 0.0)),
        "p_over_cop_eu": float(getattr(risultati, "p_over_cop_eu", 0.0)),
        "p_over_mk_eu": float(getattr(risultati, "p_over_mk_eu", 0.0)),
